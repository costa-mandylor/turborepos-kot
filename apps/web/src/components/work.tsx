...
const Work = ({ position, company, location, type, duration }: PROPS) => {
  return (
    <article className="border-b-2 border-dark-content border-opacity-20 pt-8 pb-5 dark:border-light-content dark:border-opacity-20">
      <div className="flex items-center justify-between">
        ...
        <div className="btn inline-block min-w-fit rounded-3xl bg-greenbg px-3 py-1 text-xs text-green-text">
          {type}
        </div>
      </div>
